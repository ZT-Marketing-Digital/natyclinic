...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Naty — IA que responde e agenda pacientes 24h no WhatsApp" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Naty — IA que responde e agenda pacientes 24h no WhatsApp" },
      {
        ...
        content:
          "IA que responde, qualifica e agenda pacientes 24h. Integração oficial Clinicorp. Setup em 7 dias.",
      },
